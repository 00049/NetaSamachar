...
export const POLITICIANS: Politician[] = [
  {
    ...
    name: 'Nishant',
    nameHindi: 'निशांत',
    photoUrl: '/images/nishant_real.jpg',
    partyId: 'jdu',
    constituency: 'Member of Legislative Council (MLC)',
    state: 'Bihar',
    position: 'Cabinet Minister for Health',
    chamber: 'legislative_council',
    education: '12th Pass (Engineering Dropout from BIT Mesra)',
    age: 45,
    yearsInPolitics: 1,
    careerTimeline: [
      { title: 'Director, Bihar Agri Life Natural Pvt Ltd & Techglaz Labs', startYear: 2023, endYear: 2026 },
      { title: 'Member of Legislative Council (MLC)', startYear: 2026, endYear: 'Present', government: 'Bihar Legislative Council' },
      { title: 'Cabinet Minister for Health', startYear: 2026, endYear: 'Present', government: 'Government of Bihar' }
    ],
    ...
    assetDeclarations: [
      { 
        year: 2026, 
        totalAssets: 36100000, 
        totalLiabilities: 0, 
        movableAssets: 20000000, 
        immovableAssets: 16100000, 
        spouseAssets: 0,
        assetComposition: {
          cash: 17409,
          bankDeposits: 12109000,
          mutualFunds: 1100000,
          otherMovable: 3435000,
          jewellery: 0,
          agriculturalLand: 7000000, // estimated from inherited proportion
          residentialProperty: 9100000, // Shiv Radhika Penthouse registered value
        }
      }
    ],
    evidenceIds: ['ev-nish-1', 'ev-nish-2', 'ev-nish-3', 'ev-nish-4', 'ev-nish-5', 'ev-nish-6', 'ev-nish-7', 'ev-nish-8'],
    latestNetWorth: 36100000,
    bio: 'Nishant is the Cabinet Minister for Health in Bihar and the son of former CM Nitish Kumar. After decades of a private, spiritual life, he debuted in politics in March 2026 as a Member of the Legislative Council (MLC), quickly driving major digital and administrative reforms in the state\'s healthcare infrastructure.',
    termsSince: 2026,
    verified: true,
