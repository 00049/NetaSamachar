    ...
    <div className="max-w-[1440px] mx-auto px-6 md:px-10 xl:px-20 py-32 lg:py-40">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        ...
        <Link 
          ...
          className="flex items-center justify-center font-bold uppercase text-[#090B12] bg-white hover:bg-white/90 transition-colors duration-200 px-6 py-3 rounded-sm gap-2 shrink-0"
