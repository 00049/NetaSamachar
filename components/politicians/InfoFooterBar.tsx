...
export function InfoFooterBar() {
  ...
  return (
    <div className="w-full border-b border-white/5 bg-[#131722] py-[16px] px-[40px]">
      <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-[16px] apple-meta">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-[24px]">
          <div className="flex items-center gap-[8px] text-[#A1A1AA]">
        ...
        <div className="flex items-center gap-[24px]">
          ...
          <Link href="/about" className="flex items-center gap-[4px] text-[#A1A1AA] hover:text-white transition-all duration-[220ms] group">
