...
function PoliticianCardSkeleton() {
  return (
    <div className="animate-pulse bg-white/[0.04] border border-white/[0.08] rounded-sm p-6 h-[340px] flex flex-col items-center">
      {/* Avatar */}
      <div className="w-[88px] h-[88px] rounded-full bg-white/[0.12] mb-6 shrink-0" />
      {/* Name */}
      <div className="h-6 w-3/4 bg-white/[0.12] rounded mb-2" />
      <div className="h-4 w-1/2 bg-white/[0.08] rounded mb-8" />
      {/* Party chip */}
      <div className="h-[26px] w-16 bg-white/[0.08] rounded-xs mb-8" />
      {/* Stats */}
      <div className="w-full space-y-3 mt-auto">
        <div className="flex justify-between">
          <div className="h-3 w-20 bg-white/[0.08] rounded" />
          <div className="h-3 w-10 bg-white/[0.08] rounded" />
        </div>
        <div className="h-[6px] w-full bg-white/[0.08] rounded-xs" />
      </div>
    </div>
  );
}
...
export function PromiseCardSkeleton() {
  return (
    <div className="animate-pulse border border-white/[0.08] rounded-md p-6 space-y-4">
      <div className="flex items-center gap-3">
        <div className="h-4 w-20 bg-white/[0.12] rounded" />
        <div className="h-4 w-16 bg-white/[0.08] rounded" />
      </div>
      <div className="h-6 w-2/3 bg-white/[0.12] rounded" />
...
export function StatsStripSkeleton() {
  return (
    <div className="animate-pulse grid grid-cols-2 md:grid-cols-4 gap-0 border border-white/[0.08]">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="p-6 border-r border-white/[0.08] last:border-r-0 space-y-3">
          <div className="h-3 w-20 bg-white/[0.12] rounded" />
          <div className="h-10 w-16 bg-white/[0.12] rounded" />
        </div>
      ))}
    </div>
  );
